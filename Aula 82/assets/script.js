...
class Bola{
    constructor(arrayBolas, palco){
        this.tam = Math.floor(Math.random()*15)+10 //Tamanho da bolinha.
        ...
        this.palco= palco
        this.id=Date.now()+"_"+Math.floor(Math.random()*10000000000000000000)
        this.desenhar()
    ...
    minhaPos=()=>{
        return this.arrayBolas.indexOf(this) //Vai retornar a posição da bolinha dentro do Array bolas.
    }
